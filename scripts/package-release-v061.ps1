...
$ReleaseTag = '0.6.1-rtx3090'
$RepoRoot = Split-Path -Parent $PSScriptRoot
$BuildRoot = Join-Path $RepoRoot 'build-v061-windows'
...
$ChecksumPath = Join-Path $DistRoot 'SHA256SUMS-v0.6.1-windows.txt'
...
Copy-Item -LiteralPath (Join-Path $RepoRoot 'RELEASE_NOTES_0.6.1.md') -Destination $ProductRoot
