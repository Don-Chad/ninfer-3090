...
int main(int argc, char** argv) {
    ...
    try {
        ...
        engine_options.speculative.prompt_lookup_min_context = options.prompt_lookup_min_context;
        engine_options.speculative.prompt_lookup_auto        = options.prompt_lookup_auto;
        ...
        env.prompt_lookup_min_context = options.prompt_lookup_min_context;
        env.prompt_lookup_auto        = options.prompt_lookup_auto;
