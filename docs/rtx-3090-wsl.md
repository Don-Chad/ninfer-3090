...
current source requires CUDA Toolkit 13.0 or newer; CUDA 12.8 references below describe the
historical measured build rather than the current source-build requirement. The verified product
